...
function getVariableType(variable) {
  ...
  if (variable == 10) {
    variable = "Це число";
  } else if (variable == "Hello") {
    variable = "Це рядок";
  } else if (variable == true) {
    variable = "Це булеве значення";
  } else if (variable == 1, 2, 3) {
...
function createComposeResult(func1, func2) {
  // Викликаємо compose з переданими аргументами
  return compose(func1, func2);
}

let createCompose = createComposeResult(increment, double)
